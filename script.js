...
const Config = {
  ...
  memories: [
    { id: 1, image: "images/photo01.jpg", caption: "Moments that shine forever...", type: "polaroid", aspectRatio: "3/4", accent: "tape-top-right", number: "No. 01", fallbackRoman: "I" },
    { id: 2, image: "images/photo02.jpg", caption: "A little moment of grace...", type: "postcard", aspectRatio: "3/4", accent: "postmark", number: "No. 02", fallbackRoman: "II" },
    { id: 3, image: "images/photo03.jpg", caption: "Smiling my way through life..🌸", type: "polaroid", aspectRatio: "3/4", accent: "pressed-flower", number: "No. 03", fallbackRoman: "III" },
    { id: 4, image: "images/photo04.jpg", caption: "Simply being herself...", type: "polaroid", aspectRatio: "4/3", accent: "tape-top-left", number: "No. 04", fallbackRoman: "IV" },
    { id: 5, image: "images/photo05.jpg", caption: "A smile that brightens the day...", type: "postcard", aspectRatio: "3/4", accent: "stamp-air", number: "No. 05", fallbackRoman: "V" },
    { id: 6, image: "images/photo06.jpg", caption: "A little sunshine in blue...", type: "polaroid", aspectRatio: "4/3", accent: "pressed-leaf", number: "No. 06", fallbackRoman: "VI" },
    { id: 7, image: "images/photo07.jpg", caption: "Simply glowing in the sunshine..✨", type: "postcard", aspectRatio: "3/4", accent: "tape-top-right", number: "No. 07", fallbackRoman: "VII" },
    { id: 8, image: "images/photo08.jpg", caption: "Just here for the vibes... ", type: "postcard", aspectRatio: "4/3", accent: "stamp-wish", number: "No. 08", fallbackRoman: "VIII" },
    { id: 9, image: "images/photo09.jpg", caption: "Surrounded by nature’s grace 🌿", type: "polaroid", aspectRatio: "3/4", accent: "pressed-flower-pink", number: "No. 09", fallbackRoman: "IX" },
    { id: 10, image: "images/photo10.jpg", caption: "Elegance in every little moment...🤍", type: "postcard", aspectRatio: "4/3", accent: "tape-top-left", number: "No. 10", fallbackRoman: "X" }
  ],
  finalMessage: {
    recipientName: "Zoya",
    signature: "— Atif",
    lines: [
      ...
      { text: "I hope this little gift", class: "" },
...
const soundManager = {
  ...
  playSound(type, scale = 1) {
    ...
    // Apply global fireworkSoundVolume scale
    scale = MyMath.clamp(scale, 0, 1) * fireworkSoundVolume;
...
function launchAmbientShell() {
  ...
  for (let i = 0; i < shellCount; i++) {
    setTimeout(() => {
      if (!isFireworksActive || !isAmbientMode) return;
      const shellName = MyMath.randomChoice(shellNames);
      const size = MyMath.random(2.8, 3.8);
      const shellObj = shellTypes[shellName](size);
      const shell = new Shell(shellObj);

      const posX = MyMath.random(0.15, 0.85);
      const posY = MyMath.random(0.35, 0.72);

      shell.launch(posX, posY);
    }, i * 250);
  }
}
    ...
    Config.memories.forEach((mem, idx) => {
      ...
      card.innerHTML = `
        ...
        <div class="frame-body">
          ${headerHTML}
          <div class="photo-wrapper ${aspectClass}">
